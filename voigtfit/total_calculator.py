...
fe = logsum([ufloat(14.17, 0.14), ufloat(13.98, 0.06), ufloat(12.51, 0.13), ufloat(12.68, 0.2), ufloat(13.27, 0.07), ufloat(13.64, 0.08)])
s = logsum([ufloat(14.15, 0.11), ufloat(14.24, 0.11), ufloat(13.67, 0.19)])
si = logsum([ufloat(14.37, 0.09), ufloat(14.50, 0.04), ufloat(13.39, 0.08), ufloat(13.09, 0.04), ufloat(13.72, 0.08), ufloat(14.32, 0.12),
